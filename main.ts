...
function giveIntroduction () {
    ...
    game.setDialogCursor(img`
        ...
        . . . . . . . . . . . . . . . . 
        `)
    showInstruction("Kia ora Whanau")
    showInstruction("Peke atu ki te Tiki")
    showInstruction("Haere Tatau")
}
...
hero = sprites.create(img`
    ...
    . . . f f f f f f f f f . . . . 
    . . f f e e e e e e e e . . . . 
    . f f f e 1 8 e e 1 8 e . . . . 
    . f f f e e e e e e e e . . . . 
    f f f f e 3 1 3 3 1 3 e . . . . 
    f f f f e e 2 2 1 3 e e . . . . 
    f f f f f f 2 e e e . . . . . . 
    f f f e e e e e e e e e e . . . 
    f f f e e . e e e e . e e . . . 
    f f . . . 7 7 7 7 7 7 . . . . . 
    f f . . 7 . e e e e . 7 . . . . 
    . . . . . e . . . . e . . . . . 
